...
// const DATA_SEKOLAH = {
//   SMP: {
//     "Kelas 7A": ["Aima Ellovin Jiran Meliana", "Aluna Azka Inamullah", "Chila Nasyitha", "Eavelyn Aurelia Maheswari", "Fazila Izzati Kusumawardhani", "Ilma Fadhilah Mumtazah", "Kayyisah Almeera Aufar", "Mahira Anindya Maheswari", "Naura Azmi Rinjani", "Rayana Adelia Utami", "Siti Hilwa Malikah Tadzally", "Tisya Nisrina", "Zhafirah Ramadhani Husna"],
//     "Kelas 7B": ["Aisyah Zafirah Ghani", "Chaira Alessia Olivari", "Dia Almahyra Munandar", "Fathiyya Naura Khalisha", "Haura Fairuz Dwins", "Kayla Vania Rivelino", "Kayyisah Binbas Abdullah", "Kimberly Delova Yudha", "Maila Arina Agustin", "Raina Farisha Ariakirana", "Safira Nauli Siregar", "Suhailah", "Syakirah Sidqia Mahilah", "Tri Athifa Putri Kusuma"],
//     "Kelas 8A": ["Aisyah Rahma Kamila", "Aisyah Zaahirah Ramadhani Riyadi", "Faiza Raidah Ashshabira", "Louiza Zivana Karasya", "Joanne Chen Valen", "Kafiya Faida Azmi", "Makayla Haura Radiasa", "Mikayla Defti Namiyah", "Nafisa Hanun Mufti", "Naura Qaireen Imtinan Binti Rahmatsyah", "Navilata Radhiti Kusumawardhani", "Nirmala Sopian", "Zhafira Putri Aryanti"],
//     "Kelas 8B": ["Afreen Nafila Zatta Yumni Wibowo", "Aisya Adnina", "Almira Rahmadhisa Wargadipura", "Amira Syahla Adina Aulia", "Anna Luthfiyah Khansa", "Calistanindya Shafa Wardhana", "Faiza Andinar Mulia", "Khansa Kamila", "Lubna Malika Lu'lu", "Mutia Azkayra Althafunisa", "Nirvana Sopian", "Puri Sabrina Gayatri", "Rozanah Al Atsariyah", "Zahra Nusaybah"],
//     "Kelas 9A": ["Aisyah Imany", "Almaira Muazara", "Arasy Wahyuningjati", "Asiyah", "Dirgahayu Shofwatun Nisa Armadhani", "Kharima Albany Abdullah", "Mahaira Qurani Arsya", "Marsya Hanna Faradisa", "Ratu Ainun Tertia Amarta", "Rayya Fakhirah Aimar", "Tsabita Khalisha", "Yiesha Zahira Khani"],
//     "Kelas 9B": ["Aisyah", "Alesha Bellvania Mahestri", "Alya Nurmaliha Rachman", "Bintang Ilmi Khairunnisa", "Chaizarani Qisya", "Dayana Batrisyia Mujianto", "Hasna Nafisah", "Khaira Andani Soeyatwoko", "Khansa Janeeta", "Qiana Zahra Adzkia", "Sri Dewi Saraswati", "Zianka Innaya"]
//   },
//   SMK: {
//     "10 DKV": ["Aisha Lananahdhah Machmudi", "Aisha Latifa Ariadi", "Almayra Rafifa Elwidodo", "Anjali Sakhi Zada Adhigana", "Asy Syifa Ummu Hanifah", "Audia Silmi Avani Hsb", "Aura Cinta Arfani", "Daiva Ashila Pangukir", "Dian Anggita", "Elina Syifaul Qolby", "Khansa Humairo", "Luh Dayu Aqiarasya Hermawan", "Nadine Malca Zafira As'ad", "Shaqeela Allya Jasmine Rofik", "Zaura Khay Lila", "Zhafira Quinn Hara"],
//     "10 RPL": ["Adzkia Amada Raissa", "Afifa Quisha Syakira", "Aisyah", "Dinna Rafiza Az Zahra", "Elmira Hanani", "Faiha Wanda Nabilah", "Fauza Alifa Zahra", "Kayyasa Azzahra", "Kayyisa Malihah Karin", "Khallista Agnya Shalihah", "Mariska Thasya Alzena", "Mutiara Khansa Abdillah", "Najwa Naqiyya Azkal 'Azkia", "Nasywah Nabilah Harahap", "Queenshafa Rania Bilqis"],
//     "11 DKV": ["Adzkiya Jannatu Syauqiya", "Aira An Nafi Putri Rachmani", "Assyifa Karima Humaira", "Athiyah Humaira Khairani", "Ayesha Aisyah Khuzayma", "Ayumi Maydira Zahra", "Azkia Humairah Tanua", "Balqis Faiha Lubna", "Dzakiyah Hasna Citrahayi Anjali", "Fatimah Ramadhan", "Hasna Azizah Safinatunnajah", "Kalila Princessa Yunanda", "Kanza Hasinah", "Karinne Asmaya Girly", "Kaysa Khuzaimah 'Arsya", "Marwa Arina Zahira", "Nurita Zaida Aprilisa", "Qonita Nur Hasanah", "Raisya Azzahra Putri Defa", "Sabrina Syahla Sahira"],
//     "11 RPL": ["Aluna Ekin Kehara", "Azka Syakirah", "Azwa Khalisa Melantika", "Dhia Nufah", "Emiliana Olivia Carlene", "Fadya Ismy Chalila Nurdiana", "Fiorenza Kinanti Prashanda", "Hana Anladiva Suhandi", "Hilwa Ilham", "Khansa Syahidah Aulia", "Nael Muna", "Naila Putri Syarifa", "Najla Nafisah", "Nasyrah Latifa Putri", "Nisrina Asad Alkatiri", "Pelangi Pagi", "Quaneisha Syifa Nida", "Raisa Amanda Utami", "Siti Yasmin Jinan Chumaira", "Sri Mulyani Tarihoran", "Tanzani Akasyah", "Vanda Nakeysha"]
//   }
// };
...
//             notif.onclick = () => { 
//                 window.focus(); 
//                 // Ulangi suara saat notif diklik (karena browser aktif lagi)
//                 if (typeof window !== "undefined" && 'speechSynthesis' in window) {
...
// // --- FUNGSI AKTIFKAN AUDIO SAAT KLIK MENU (TRIK CERDIK!) ---
...
//   const unlockAudio = () => {
//     // INI KUNCINYA: Memutar suara kosong untuk memancing izin browser
//     if (typeof window !== 'undefined' && 'speechSynthesis' in window) {
//         const u = new SpeechSynthesisUtterance(" "); // Suara hening
//         window.speechSynthesis.speak(u);
//     }
//   };

//   const handleMenuClick = (roleTujuan) => {
//     // 1. Aktifkan Audio Engine saat user klik apapun di menu
//     unlockAudio();

//     // 2. Lanjut logika menu biasa
...
//         <button onClick={() => handleMenuClick("ORTU")} className="group relative overflow-hidden bg-white p-6 rounded-3xl shadow-xl shadow-slate-200 border border-white hover:border-blue-200 transition-all duration-300 hover:scale-[1.02] text-left"><div className="absolute top-0 right-0 w-24 h-24 bg-blue-50 rounded-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div><span className="text-4xl mb-3 block relative z-10">👨‍👩‍👧‍👦</span><div className="relative z-10"><h3 className="text-xl font-bold text-slate-800">Layar Orang Tua</h3><p className="text-sm text-slate-400">Untuk melihat nomor antrian</p></div></button>
...
//       </div>
//       <p className="mt-12 text-xs text-slate-300 font-medium">v5.0 • Silent Audio Unlock</p>
//     </div>
//   );
// }
...
function MenuAwal({ setRole, saveState }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50 p-6 font-sans text-slate-800 relative">
      ...
      <p className="mt-12 text-xs text-slate-300 font-medium">v6.0 • ID Voice Fix</p>
    </div>
  );
}
